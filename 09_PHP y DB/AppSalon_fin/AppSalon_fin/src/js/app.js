...
async function mostrarServicios() {
	try {
		// URL where JSON service is
		const url = "http://localhost:3000/service.php";

		// Fetch to the JSON service
		...
		db.forEach((servicio) => {
			const { id_service, name, price } = servicio;
			...
			servicioDiv.dataset.idServicio = id_service;
